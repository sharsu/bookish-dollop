  ...
  concepts: [
    {
      ...
      explanation: [
        "The worked examples below show the main idea: small objects use small units and large distances use larger units.",
      ...
      visualLabel: "A full-width measurement visual showing sensible units for a pencil, classroom and road trip.",
      visual: createMeasurementUnitChoiceVisual({ accent: "#06b6d4" })
    },
    {
      title: "Converting Units",
      summary: "Unit conversion is really about changing scale while keeping the same amount.",
      explanation: [
        "The example below shows the conversion ladder idea: moving to a larger unit means dividing, and moving to a smaller unit means multiplying.",
      ...
      visualLabel: "A full-width conversion example showing 250 cm changed into metres and reminding the child about area conversion.",
      visual: createMeasurementConversionVisual({ accent: "#0ea5e9" })
    },
    {
      title: "Perimeter & Area",
      summary: "Perimeter is the distance around a shape. Area is the space inside it.",
      explanation: [
        "The diagrams below show the two different jobs clearly: perimeter travels around the edge, while area covers the inside.",
      ...
      visualLabel: "A full-width worked example showing a rectangle for perimeter and area, plus a triangle area formula example.",
      visual: createMeasurementAreaVisual({ accent: "#f59e0b" })
    },
    {
      ...
      explanation: [
        "The scale below is a worked example of the best method: find the value of one gap first, then read the marked point.",
      ...
      visualLabel: "A full-width scale example showing how to find the value of one gap before reading the final mark.",
      visual: createMeasurementScaleVisual({ accent: "#22c55e" })
    }
  ]
});
