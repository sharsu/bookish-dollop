...
(() => {
  ...
  root.SKILLS = [
    ...
    { id: "num-primes-factors", topic: "Numbers", title: "Primes and factors",
      ...
      templates: ["numIsPrime", "numFactorCount", "numPrimeFactorCount", "numPrimeSumSquare", "numSquaresMinusCubes", "numFactorStatements", "numDivisibilityRule", "numSmallestWithFactors"] },
    ...
    { id: "frac-add-subtract", topic: "Fractions", title: "Adding and subtracting fractions",
      ...
      templates: ["fracAdd", "fracSubtract", "fracMixedAddSubtract"] },
    { id: "frac-multiply-divide", topic: "Fractions", title: "Multiplying and dividing fractions",
      ...
      concepts: ["fractions-of-amounts-simple-calculations"],
      templates: ["fracMultiply", "fracDivide", "fracMixedMultiply", "fracDivideMixed"] },
    ...
    { id: "frac-of-amount", topic: "Fractions", title: "A fraction of an amount",
      ...
      templates: ["fracOfX", "fracOfFrac", "figShadedFraction", "figShadedTriangles", "fracReverseOf"] },
    ...
    { id: "pct-change", topic: "Percentages", title: "Increases, discounts and interest",
      ...
      templates: ["pctSalePrice", "pctIncrease", "pctSimpleInterest", "pctSaleChange", "pctProfitPercent"] },
    { id: "pct-reverse", topic: "Percentages", title: "Working back to the whole",
      ...
      templates: ["pctReverse", "pctReverseAfterChange"] },
    { id: "pct-chained", warmUp: "pct-basics", topic: "Percentages", title: "Percentages one after another",
      ...
      concepts: ["percentage-change"],
      templates: ["pctChained", "pctProfitAfterLoss", "pctProfitPerItem", "pctSingleEquivalent"] },
    ...
    { id: "alg-solve", topic: "Algebra", title: "Solving equations",
      ...
      concepts: ["equations"],
      templates: ["algSolve1Step", "algSolve2Step", "algSolveBothSides", "algChainSubstitute", "algPowerEquation", "algRemainderDivisor", "algInequalityInteger", "algInequalityCount"] },
    ...
    { id: "alg-word-problems", warmUp: "alg-solve", topic: "Algebra", title: "Turning words into equations",
      ...
      templates: ["algWeightPair", "algTriangleAngles", "algThreeItemPricing", "algSimultaneous", "algPerimeterEquation"] },
    ...
    { id: "spd-formula", topic: "Speed", title: "Speed, distance and time",
      ...
      templates: ["spdFindSpeed", "spdFindDistance", "spdFindTime", "spdMphHoursMin", "spdSpeedFromMinutes", "spdUnitConvert", "spdTimetable"] },
    ...
    { id: "spd-average", warmUp: "spd-formula", topic: "Speed", title: "Average speed",
      ...
      templates: ["spdAverageTwoLegs", "spdAverageThreeLegs", "spdReturnUnknownDistance"] },
    ...
    { id: "stat-averages-backwards", warmUp: "stat-averages", topic: "Statistics", title: "Working backwards from an average",
      ...
      concepts: ["mean-median-mode-range"],
      templates: ["statMissingMean", "statCombinedMean", "statMeanAfterChange"] },
    ...
    { id: "count-choosing", warmUp: "count-stages", topic: "Counting Principle",
      ...
      templates: ["countChooseCommittee", "countHandshakes", "countGridPaths", "countChooseFromTwoGroups"] },
    { id: "count-identical", warmUp: "count-order-matters", topic: "Counting Principle",
      ...
      concepts: ["restrictions-and-rules"],
      templates: ["countWordRepeatedLetters", "countCircular", "countCircularReflect"] },
